...
class Magazento_CustomReg_Block_Form extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account {//Mage_Customer_Block_Widget_Abstract{//Mage_Core_Block_Template {
...
//    }
    ...
    public function getAllFields($formType){
     //   Mage::log('in getAllFields');
        $model=Mage::getModel('customreg/attribute');
      //   $customer = Mage::getSingleton('customer/session')->getCustomer();
       $AttrCollection=$model->getUserAttr($formType);
       $atrArr=array();
...
//            'legend' => Mage::helper('customer')->__('Custom Information')
//                ));
//
